...
module.exports = {
    ...
    lotus: {
        api: process.env.LOTUS_API || 'http://192.168.24.25:3633/rpc/v0',
        token: process.env.LOTUS_TOKEN || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJBbGxvdyI6WyJyZWFkIiwid3JpdGUiLCJzaWduIiwiYWRtaW4iXX0.5xAL-Byu-udL2p7Ojjf8Sgsx4BRWwJJ8lyhmvg3S6Ck',
    },
    prometheus: {
